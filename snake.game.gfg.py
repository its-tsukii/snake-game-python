...
color_1 = (255, 255, 255) # color code for white
color_2 = (255, 255, 102) # color code for yellow
color_3 = (0, 0, 0) # color code for black
color_4 = (213, 200, 80)
...
def final_score(score):
    value = score_font.render("The Snake Game ------ Your Best is : " + str(score), True, color_2)
...
def game_start():
    ...
    foodx_pos = round(random.randrange(0, box_len-snake_block)/10.00) * 10.00
    foody_pos = round(random.randrange(0, box_height-snake_block)/10.00) * 10.00

    while not game_over:

        while game_close == True:
            add_caption.fill(color_6)
            display_msg("Snake Hit Something ! Another Round ? Press C else", color_4)
